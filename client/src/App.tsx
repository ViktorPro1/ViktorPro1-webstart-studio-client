...
// --- ЛІНИВИЙ ІМПОРТ ---
const DjonAssistant = lazy(
  () => import("./components/DjonAssistant/DjonAssistant"),
);
const CookieConsent = lazy(() => import("./components/CookieConsent"));
const UpdateNotification = lazy(
  () => import("./components/UpdateNotification"),
);
const ChristmasDecorations = lazy(
  () => import("./components/NewYear/ChristmasDecorations"),
);
...
const CopyProtectionModal = lazy(
  () => import("./components/UI/CopyProtectionModal"),
);
const SocialProofNotification = lazy(
  () => import("./components/UI/SocialProofNotification"),
);
