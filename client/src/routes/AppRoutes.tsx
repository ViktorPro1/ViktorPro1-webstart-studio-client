...
const TechnicalDetails = lazy(
  () => import("../pages/TechnicalDetails/TechnicalDetails"),
);
const PlatformComparison = lazy(
  () => import("../pages/PlatformComparison/PlatformComparison"),
);
const DiyVsUs = lazy(() => import("../pages/DiyVsUs/DiyVsUs"));
const CommonMistakes = lazy(
  () => import("../pages/CommonMistakes/CommonMistakes"),
);
...
const EditInstruction = lazy(
  () => import("../pages/EditInstruction/EditInstruction"),
);
...
const CertificateGift = lazy(
  () => import("../pages/CertificateGift/CertificateGift"),
);
const InteractiveQuiz = lazy(
  () => import("../pages/InteractiveQuiz/InteractiveQuiz"),
);
...
const YouTubeChannel = lazy(
  () => import("../pages/YouTubeChannel/YouTubeChannel"),
);
const CanvaServices = lazy(
  () => import("../pages/CanvaServices/CanvaServices"),
);
...
const DataAnalytics = lazy(
  () => import("../pages/DataAnalytics/DataAnalytics"),
);
...
const ThirdPartyCookies = lazy(
  () => import("../pages/Legal/ThirdPartyCookies"),
);

/* ===== Added Legal Pages ===== */
const PrivacyPolicyFull = lazy(
  () => import("../components/PrivacyPolicy/PrivacyPolicy"),
);
const TermsOfUse = lazy(() => import("../components/TermsOfUse/TermsOfUse"));

/* ===== Generators ===== */
const PortfolioTextGenerator = lazy(
  () =>
    import("../pages/Generators/PortfolioTextGenerator/PortfolioTextGenerator"),
);
const ProjectChecker = lazy(
  () => import("../pages/Generators/ProjectChecker/ProjectChecker"),
);
const ResumeStructureGenerator = lazy(
  () =>
    import("../pages/Generators/ResumeStructureGenerator/ResumeStructureGenerator"),
);

/* ===== Templates ===== */
const PortfolioTemplates = lazy(
  () => import("../pages/Templates/PortfolioTemplates/PortfolioTemplates"),
);
const ResumeTemplates = lazy(
  () => import("../pages/Templates/ResumeTemplates/ResumeTemplates"),
);
const LandingTemplates = lazy(
  () => import("../pages/Templates/LandingTemplates/LandingTemplates"),
);
...
const AIAutomation = lazy(
  () => import("../pages/AIServices/AIAutomation/AIAutomation"),
);
const AIPrompting = lazy(
  () => import("../pages/AIServices/AIPrompting/AIPrompting"),
);
const PromptEditor = lazy(
  () => import("../pages/AIServices/PromptEditor/PromptEditor"),
);
const PromptShowcase = lazy(
  () => import("../pages/AIServices/PromptShowcase/PromptShowcase"),
);
const PromptStudio = lazy(
  () => import("../pages/AIServices/PromptStudio/PromptStudio"),
);

/* ===== Google Ads ===== */
const GoogleAdsLearning = lazy(
  () => import("../pages/Google-Ads/GoogleAdsLearning/GoogleAdsLearning"),
);
const GoogleAdsCalculator = lazy(
  () => import("../pages/Google-Ads/GoogleAdsCalculator/GoogleAdsCalculator"),
);
const GoogleAdsGenerator = lazy(
  () => import("../pages/Google-Ads/GoogleAdsGenerator/GoogleAdsGenerator"),
);
const GoogleAdsComparison = lazy(
  () => import("../pages/Google-Ads/GoogleAdsComparison/GoogleAdsComparison"),
);
const GoogleAdsGlossary = lazy(
  () => import("../pages/Google-Ads/GoogleAdsGlossary/GoogleAdsGlossary"),
);
const GoogleAdsKeywords = lazy(
  () => import("../pages/Google-Ads/GoogleAdsKeywords/GoogleAdsKeywords"),
);

/* ===== Facebook Ads ===== */
const AdCalculator = lazy(
  () => import("../pages/Facebook-Ads/AdCalculator/AdCalculator"),
);
const TargetAdvertising = lazy(
  () => import("../pages/Facebook-Ads/TargetAdvertising/TargetAdvertising"),
);
const TargetExplanation = lazy(
  () => import("../pages/Facebook-Ads/TargetExplanation/TargetExplanation"),
);
const UTMGenerator = lazy(
  () => import("../pages/Facebook-Ads/UTMGenerator/UTMGenerator"),
);
  ...
  <Suspense fallback={<Loader />}>
    <Routes>
      ...
      <Route
        path="/messages"
        element={
          <ProtectedRoute requiresBackend allowGuest>
            <Messages />
          </ProtectedRoute>
        }
      />
      ...
      <Route
        ...
        element={<PortfolioTextGenerator />}
      />
